...
public class MaximiseSatisfactionReimplemented {
  ...
  public Double calculateSatisfaction(Customer customer) {
    ...
    List<Valuation> directValuations =
  ...
  public Double calculateFulfillment(Requirement requirement, Customer customer) {
    ...
    Optional<RequirementRealisation> maxRealisation =
    ...
    double aggregatedDepFulfillments = 0.0;
