 ...
 * </p>
 * <ul>
 *   <li>{@link nrp.model.nrp.impl.RequirementRealisationImpl#getRequirement <em>Requirement</em>}</li>
 *   <li>{@link nrp.model.nrp.impl.RequirementRealisationImpl#getPercentage <em>Percentage</em>}</li>
 *   <li>{@link nrp.model.nrp.impl.RequirementRealisationImpl#getDependsOn <em>Depends On</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequirementRealisationImpl extends MinimalEObjectImpl.Container implements RequirementRealisation {
	...
	protected EClass eStaticClass() {
		return NRPPackage.Literals.REQUIREMENT_REALISATION;
	}
	...
	public Requirement getRequirement() {
		if (eContainerFeatureID() != NRPPackage.REQUIREMENT_REALISATION__REQUIREMENT)
			return null;
	...
	public NotificationChain basicSetRequirement(Requirement newRequirement, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newRequirement, NRPPackage.REQUIREMENT_REALISATION__REQUIREMENT,
				msgs);
		return msgs;
	}
	...
	public void setRequirement(Requirement newRequirement) {
		if (newRequirement != eInternalContainer()
				|| (eContainerFeatureID() != NRPPackage.REQUIREMENT_REALISATION__REQUIREMENT
						&& newRequirement != null)) {
			...
			if (newRequirement != null)
				msgs = ((InternalEObject) newRequirement).eInverseAdd(this, NRPPackage.REQUIREMENT__REALISATIONS,
						Requirement.class, msgs);
			msgs = basicSetRequirement(newRequirement, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NRPPackage.REQUIREMENT_REALISATION__REQUIREMENT,
	...
	public void setPercentage(double newPercentage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NRPPackage.REQUIREMENT_REALISATION__PERCENTAGE,
	...
	public EList<SoftwareArtifact> getDependsOn() {
		if (dependsOn == null) {
			dependsOn = new EObjectWithInverseResolvingEList.ManyInverse<SoftwareArtifact>(SoftwareArtifact.class, this,
					NRPPackage.REQUIREMENT_REALISATION__DEPENDS_ON, NRPPackage.SOFTWARE_ARTIFACT__CONTRIBUTES_TO);
		}
		return dependsOn;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case NRPPackage.REQUIREMENT_REALISATION__REQUIREMENT:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetRequirement((Requirement) otherEnd, msgs);
		case NRPPackage.REQUIREMENT_REALISATION__DEPENDS_ON:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case NRPPackage.REQUIREMENT_REALISATION__REQUIREMENT:
			return eInternalContainer().eInverseRemove(this, NRPPackage.REQUIREMENT__REALISATIONS, Requirement.class,
					msgs);
		}
