 ...
 * </p>
 * <ul>
 *   <li>{@link nrp.model.nrp.impl.CostImpl#getType <em>Type</em>}</li>
 *   <li>{@link nrp.model.nrp.impl.CostImpl#getAmount <em>Amount</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CostImpl extends MinimalEObjectImpl.Container implements Cost {
	...
	protected EClass eStaticClass() {
		return NRPPackage.Literals.COST;
	}
	...
	public void setType(CostType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NRPPackage.COST__TYPE, oldType, type));
	}
	...
	public void setAmount(double newAmount) {
		...
		amount = newAmount;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NRPPackage.COST__AMOUNT, oldAmount, amount));
	}
