...
public class MaximiseSatisfactionFixed {
	...
	public Double calculateSatisfaction(Customer customer) {
		...
		List<Valuation> maxDirectValuations = selectMaximalValuations(directValuations);
	...
	public Double calculateFulfillment(Requirement requirement, Customer customer) {
	    ...
	    if (!dependencyValuations.isEmpty()) {
	    	List<Valuation> maxDependencyValuations = selectMaximalValuations(dependencyValuations);
