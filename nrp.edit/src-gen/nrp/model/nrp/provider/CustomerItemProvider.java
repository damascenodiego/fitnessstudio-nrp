...
/**
 * This is the item provider adapter for a {@link nrp.model.nrp.Customer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CustomerItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAssignsPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Customer_name_feature",
								"_UI_Customer_type"),
						NRPPackage.Literals.CUSTOMER__NAME, true, false, false,
	...
	protected void addImportancePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Customer_importance_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Customer_importance_feature",
								"_UI_Customer_type"),
						NRPPackage.Literals.CUSTOMER__IMPORTANCE, true, false, false,
						ItemPropertyDescriptor.REAL_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Assigns feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAssignsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Customer_assigns_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Customer_assigns_feature",
								"_UI_Customer_type"),
						NRPPackage.Literals.CUSTOMER__ASSIGNS, true, false, true, null, null, null));
	}
