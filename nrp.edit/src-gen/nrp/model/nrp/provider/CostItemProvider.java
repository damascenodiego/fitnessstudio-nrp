...
/**
 * This is the item provider adapter for a {@link nrp.model.nrp.Cost} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CostItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Cost_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Cost_type_feature", "_UI_Cost_type"),
						NRPPackage.Literals.COST__TYPE, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	protected void addAmountPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Cost_amount_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Cost_amount_feature", "_UI_Cost_type"),
						NRPPackage.Literals.COST__AMOUNT, true, false, false, ItemPropertyDescriptor.REAL_VALUE_IMAGE,
						null, null));
	}
	...
	public String getText(Object object) {
		CostType labelValue = ((Cost) object).getType();
	...
	public void notifyChanged(Notification notification) {
		...
		case NRPPackage.COST__TYPE:
		case NRPPackage.COST__AMOUNT:
