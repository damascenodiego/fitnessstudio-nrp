...
import nrp.model.nrp.NRPFactory;
 ...
 * @generated
 */
public class NRPPackageImpl extends EPackageImpl implements NRPPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see nrp.model.nrp.NRPPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private NRPPackageImpl() {
		super(eNS_URI, NRPFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link NRPPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static NRPPackage init() {
		if (isInited)
			return (NRPPackage) EPackage.Registry.INSTANCE.getEPackage(NRPPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredNRPPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		NRPPackageImpl theNRPPackage = registeredNRPPackage instanceof NRPPackageImpl
				? (NRPPackageImpl) registeredNRPPackage
				: new NRPPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theNRPPackage.createPackageContents();

		// Initialize created meta-data
		theNRPPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theNRPPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(NRPPackage.eNS_URI, theNRPPackage);
		return theNRPPackage;
	}
	...
	public EReference getNRP_Customers() {
		return (EReference) nrpEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public NRPFactory getNRPFactory() {
		return (NRPFactory) getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEClass(nrpEClass, nrp.model.nrp.NRP.class, "NRP", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getNRP_Customers(), this.getCustomer(), null, "customers", null, 1, -1, nrp.model.nrp.NRP.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNRP_AvailableArtifacts(), this.getSoftwareArtifact(), null, "availableArtifacts", null, 1, -1,
				nrp.model.nrp.NRP.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNRP_Requirements(), this.getRequirement(), null, "requirements", null, 1, -1,
				nrp.model.nrp.NRP.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNRP_Solutions(), this.getSolution(), null, "solutions", null, 0, -1, nrp.model.nrp.NRP.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCustomer_Importance(), ecorePackage.getEDouble(), "importance", null, 0, 1, Customer.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCustomer_Assigns(), this.getValuation(), this.getValuation_AssignedBy(), "assigns", null, 1,
		...
		initEAttribute(getCost_Type(), this.getCostType(), "type", null, 0, 1, Cost.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCost_Amount(), ecorePackage.getEDouble(), "amount", null, 0, 1, Cost.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(softwareArtifactEClass, SoftwareArtifact.class, "SoftwareArtifact", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSoftwareArtifact_Name(), ecorePackage.getEString(), "name", null, 0, 1,
				SoftwareArtifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getSoftwareArtifact_Requires(), this.getSoftwareArtifact(), null, "requires", null, 0, -1,
				SoftwareArtifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSoftwareArtifact_Costs(), this.getCost(), null, "costs", null, 1, -1, SoftwareArtifact.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSoftwareArtifact_ContributesTo(), this.getRequirementRealisation(),
				this.getRequirementRealisation_DependsOn(), "contributesTo", null, 1, -1, SoftwareArtifact.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSoftwareArtifact_Solutions(), this.getSolution(), this.getSolution_SelectedArtifacts(),
				"solutions", null, 0, -1, SoftwareArtifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
		...
		initEAttribute(getRequirement_Name(), ecorePackage.getEString(), "name", null, 0, 1, Requirement.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRequirement_Valuations(), this.getValuation(), this.getValuation_Requirement(), "valuations",
				null, 1, -1, Requirement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRequirement_Realisations(), this.getRequirementRealisation(),
				this.getRequirementRealisation_Requirement(), "realisations", null, 0, -1, Requirement.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRequirement_Combines(), this.getValuation(), this.getValuation_ContributesTo(), "combines",
				null, 0, -1, Requirement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(requirementRealisationEClass, RequirementRealisation.class, "RequirementRealisation", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRequirementRealisation_Requirement(), this.getRequirement(),
				this.getRequirement_Realisations(), "requirement", null, 1, 1, RequirementRealisation.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRequirementRealisation_Percentage(), ecorePackage.getEDouble(), "percentage", "1.0", 0, 1,
				RequirementRealisation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRequirementRealisation_DependsOn(), this.getSoftwareArtifact(),
				this.getSoftwareArtifact_ContributesTo(), "dependsOn", null, 1, -1, RequirementRealisation.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(solutionEClass, Solution.class, "Solution", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSolution_SelectedArtifacts(), this.getSoftwareArtifact(),
				this.getSoftwareArtifact_Solutions(), "selectedArtifacts", null, 0, -1, Solution.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(valuationEClass, Valuation.class, "Valuation", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getValuation_Requirement(), this.getRequirement(), this.getRequirement_Valuations(),
				"requirement", null, 1, 1, Valuation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getValuation_Value(), ecorePackage.getEDouble(), "value", null, 0, 1, Valuation.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getValuation_AssignedBy(), this.getCustomer(), this.getCustomer_Assigns(), "assignedBy", null, 1,
				-1, Valuation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getValuation_ContributesTo(), this.getRequirement(), this.getRequirement_Combines(),
				"contributesTo", null, 0, -1, Valuation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
