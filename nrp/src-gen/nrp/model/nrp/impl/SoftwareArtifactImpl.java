 ...
 * </p>
 * <ul>
 *   <li>{@link nrp.model.nrp.impl.SoftwareArtifactImpl#getName <em>Name</em>}</li>
 *   <li>{@link nrp.model.nrp.impl.SoftwareArtifactImpl#getRequires <em>Requires</em>}</li>
 *   <li>{@link nrp.model.nrp.impl.SoftwareArtifactImpl#getCosts <em>Costs</em>}</li>
 *   <li>{@link nrp.model.nrp.impl.SoftwareArtifactImpl#getContributesTo <em>Contributes To</em>}</li>
 *   <li>{@link nrp.model.nrp.impl.SoftwareArtifactImpl#getSolutions <em>Solutions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SoftwareArtifactImpl extends MinimalEObjectImpl.Container implements SoftwareArtifact {
	...
	protected EClass eStaticClass() {
		return NRPPackage.Literals.SOFTWARE_ARTIFACT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NRPPackage.SOFTWARE_ARTIFACT__NAME, oldName, name));
	}
	...
	public EList<SoftwareArtifact> getRequires() {
		if (requires == null) {
			requires = new EObjectResolvingEList<SoftwareArtifact>(SoftwareArtifact.class, this,
					NRPPackage.SOFTWARE_ARTIFACT__REQUIRES);
		}
		return requires;
	}
	...
	public EList<Cost> getCosts() {
		if (costs == null) {
			costs = new EObjectContainmentEList<Cost>(Cost.class, this, NRPPackage.SOFTWARE_ARTIFACT__COSTS);
		}
		return costs;
	}
	...
	public EList<RequirementRealisation> getContributesTo() {
		if (contributesTo == null) {
			contributesTo = new EObjectWithInverseResolvingEList.ManyInverse<RequirementRealisation>(
					RequirementRealisation.class, this, NRPPackage.SOFTWARE_ARTIFACT__CONTRIBUTES_TO,
					NRPPackage.REQUIREMENT_REALISATION__DEPENDS_ON);
		}
	...
	public EList<Solution> getSolutions() {
		if (solutions == null) {
			solutions = new EObjectWithInverseResolvingEList.ManyInverse<Solution>(Solution.class, this,
					NRPPackage.SOFTWARE_ARTIFACT__SOLUTIONS, NRPPackage.SOLUTION__SELECTED_ARTIFACTS);
		}
		return solutions;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case NRPPackage.SOFTWARE_ARTIFACT__CONTRIBUTES_TO:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getContributesTo()).basicAdd(otherEnd, msgs);
		case NRPPackage.SOFTWARE_ARTIFACT__SOLUTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case NRPPackage.SOFTWARE_ARTIFACT__NAME:
			return getName();
		case NRPPackage.SOFTWARE_ARTIFACT__REQUIRES:
			return getRequires();
		case NRPPackage.SOFTWARE_ARTIFACT__COSTS:
			return getCosts();
		case NRPPackage.SOFTWARE_ARTIFACT__CONTRIBUTES_TO:
